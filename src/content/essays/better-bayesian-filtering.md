...
1. Case is preserved.- Exclamation points are constituent characters.- Periods and commas are constituents if they occur
...
points,  letters, and occurring in one of the
...
caps as well as all  and all lowercase. Spams
...
from someone in Egypt and written in all . This was
...
the mail from Egypt got nailed because the  text
made it look to the filter like a Nigerian spam.
This really is kind of a bug. As with
html, the email being all  is really conceptually *one*
...
case: I should degenerate from  to any-case, not
lowercase.
