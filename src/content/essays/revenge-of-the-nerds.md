...
[theoretical exercise](/read/the-roots-of-lisp)-- an effort
...
> This was the Lisp function [*eval*](https://sep.turbifycdn.com/ty/cdn/paulgraham/jmc.lisp?t=1767460192&)...,
...
software shifts
[off the desktop](/read/the-other-road-ahead) and onto servers (a future even
...
[code size](/read/succinctness-is-power).
...
[bottom-up programming](/read/programming-bottom-up). Instead of
      ...
      write software in Lisp, you could try telling him it's XML.* Here is the accumulator generator in other Lisp dialects:
        ...
        * Erann Gat's sad tale about
          ...
          this generally misapplied phrase.* Peter Norvig found that
            ...
            "[invisible
            or simpler](http://www.norvig.com/design-patterns/)" in Lisp.* Thanks to the many people who answered my questions about
...
of language power in [Succinctness is Power](/read/succinctness-is-power).
